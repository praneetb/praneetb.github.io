...
function renderYaml(data) {
  ...
  lines.push("  image_alt: Stylized illustration of a violinist in a black tuxedo playing a brown violin on a white background. Not a photograph.");
  lines.push("  image_credit: Site illustration — see assets/images/violin/CREDITS.txt");
  lines.push("");
  lines.push("story:");
