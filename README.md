...
- [Recipes](/recipes/) — public cook-at-home scrapbook from `_data/recipes.yml`, separate from `/food/` favorites and `/cocktails/` drink videos. Cards, light search, and All / Breakfast chips. First card only: Gourmet Poblano Cream Corn & Sungold Tomato Egg Bites. Do not invent recipes.
