(function () {
  ...
  // Signed-in header only. Travel, Bar, Cocktails, Patents, and Bucket list
  // are public pages (no login wall). Media, Notes, Manya, and Space stay
  // gated via page.private — unsigned visitors never see this nav.
  var PRIVATE_LINKS = [
