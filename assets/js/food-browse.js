(function () {
  ...
  function cards() {
    return document.querySelectorAll("[data-food-card]");
  }
  ...
  function readParams() {
    ...
    if (nextChip === "desi" || nextChip === "pizza" || nextChip === "cocktails" || nextChip === "all") {
      chip = nextChip;
    }
    if (nextQuery) {
      query = nextQuery;
      var input = $("food-browse-search");
      if (input) {
